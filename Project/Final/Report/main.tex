...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \addplot[fill=gray] coordinates {
            (MRR,0.3112) (Hits@1,0.1707) (Hits@3,0.3711) (Hits@10,0.5862)
        };
        \addlegendentry{Paper}

        % Model B
        \addplot[fill=blue] coordinates {
            (MRR,0.3212) (Hits@1,0.1807) (Hits@3,0.3811) (Hits@10,0.5962)
        };
        \addlegendentry{\modelalpaca}

        % Model C
        \addplot[fill=purple] coordinates {
            (MRR,0.2950) (Hits@1,0.1500) (Hits@3,0.3600) (Hits@10,0.5800)
        };
        \addlegendentry{\modeldeepseek}

        \end{axis}
    \end{tikzpicture}
    \caption{Comparison of Link Prediction Metrics Across Models}
